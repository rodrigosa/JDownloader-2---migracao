...
public class ExceptionResponse extends MyJDownloaderException {
    ...
    public ExceptionResponse(final String content, final int responseCode, final String responseMessage) {
        super(content);
    ...
    public ExceptionResponse(final Exception e, final int responseCode, final String responseMessage) {
        super(e);
        this.content = null;
        this.responseCode = responseCode;
        this.responseMessage = responseMessage;
