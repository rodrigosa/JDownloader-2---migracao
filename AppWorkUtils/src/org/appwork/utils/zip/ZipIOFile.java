...
/**
 * @deprecated ..whatever this is... don'tuse it ;-P
 */
@Deprecated
public class ZipIOFile {
     ...
     * @param parent
     *            ZipIOFile that represents the parent of this node or null if no parent available
     */
    ...
    /**
     * returns ZipIOFile list for all the filesif this ZipIOFile represents a directory(internal use for ZipIOReader)
     *
     * @return
     */
    ...
    /**
     * returns ZipIOFile list for all the filesif this ZipIOFile represents a directory
     *
     * @return
     */
