...
public class CheckGraphicsProxy extends AWTest {
    ...
    public void runTest() throws Exception {
        Class<Graphics2DProxy> cls = Graphics2DProxy.class;
        for (Method m : cls.getSuperclass().getMethods()) {
            try {
                ...
                if ("public void java.awt.Graphics.finalize()".equals(m.toString())) {
                    continue;
                }
                System.err.println(JVMVersion.getJVMVersion() + ": Method not overridden: " + m);
                throw e;
            }
        }
    }
