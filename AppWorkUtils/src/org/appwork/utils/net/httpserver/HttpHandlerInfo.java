...
public class HttpHandlerInfo {
    ...
    public int getPort() {
        return this.getHttpServer().getPort();
    }

    public boolean isLocalhostOnly() {
        return this.getHttpServer().isLocalhostOnly();
    }

    public boolean isRunning() {
        return this.getHttpServer().isRunning();
    }

    public void unregisterRequestHandler() {
        this.getHttpServer().unregisterRequestHandler(getHttpHandler());
    }
}
