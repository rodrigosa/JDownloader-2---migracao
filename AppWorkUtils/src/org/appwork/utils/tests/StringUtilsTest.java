                ...
                }
                {
                    for (int minCount = 1; minCount < 30; minCount++) {
                        for (String fill : new String[] { "a", " ", "!" }) {
                            assertEquals(StringUtils.fillPost("test", fill, minCount), "test" + (minCount > "test".length() ? (String.format(Locale.ROOT, "%0" + (minCount - "test".length()) + "d", 0).replace("0", fill)) : ""));
                            assertEquals(StringUtils.fillPre("test", fill, minCount), (minCount > "test".length() ? (String.format(Locale.ROOT, "%0" + (minCount - "test".length()) + "d", 0).replace("0", fill)) : "") + "test");
                        }
                    }
                }
                {
