 ...
 *
 */
public class JavaSyntax extends AbstractNameScheme {
     ...
     * @param b
     */
    public JavaSyntax(boolean simple) {
        this.simple = simple;
    }
    ...
    /**
     * @see org.appwork.utils.reflection.CompiledType.AbstractNameScheme#getCollectionName(java.lang.Class)
     */
    @Override
    ...
    public void appendComponents(CompiledType type, Class<?> raw, StringBuilder sb, CompiledType[] components) {
        if (raw != null && ((Class) raw).isArray()) {
            components[0].appendName(this, sb);
            sb.append("[]");
        } else {
