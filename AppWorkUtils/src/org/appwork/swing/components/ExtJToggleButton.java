...
public class ExtJToggleButton extends JToggleButton implements ToolTipHandler {
    /**
     *
     */
     ...
     */
    public ExtJToggleButton(final AbstractAction action) {
        super(action);
            ...
            if (rollOverlistener == null) {
                rollOverlistener = new MouseAdapter() {
                    ...
                    public void mouseEntered(final MouseEvent e) {
                        ExtJToggleButton.this.onRollOver();
                    }

                    @Override
                    public void mouseExited(final MouseEvent e) {
                        ExtJToggleButton.this.onRollOut();
                    }
                    ...
                    public void mouseReleased(final MouseEvent e) {
                        ExtJToggleButton.this.onReleased();
                    }
                };
            }
    ...
    public ExtJToggleButton setTooltipsEnabled(final boolean b) {
        if (b) {
            ToolTipController.getInstance().register(this);
        } else {
