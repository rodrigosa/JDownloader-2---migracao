...
public interface JSONMapper {
    ...
    public JsonConverterForSerialization putConverterForSerialization(final Class<?> clazz, final JsonConverterForSerialization converter);

    public JsonConverterForDeserialization putConverterFromDeserialization(final Class<?> clazz, final JsonConverterForDeserialization converter);

    @Deprecated
    public JsonSerializer putSerializer(Class<?> clazz, final JsonSerializer jsonSerializer);

    @Deprecated
    public JsonDeSerializer putDeSerializer(Class<?> class1, JsonDeSerializer jsonDeSerializer);
