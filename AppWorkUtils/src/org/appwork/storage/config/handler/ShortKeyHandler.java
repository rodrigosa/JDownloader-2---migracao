...
public class ShortKeyHandler extends KeyHandler<Short> {
     ...
     * @param key
     */
    public ShortKeyHandler(final StorageHandler<?> storageHandler, final String key) {
    ...
    protected void initDefaults() throws Throwable {
        this.setDefaultValue(Short.valueOf((short) 0));
    }
    ...
    @Override
    protected void putValue(final Short object) {
    ...
    @Override
    protected void validateValue(final Short object) throws Throwable {
        if (this.validator != null) {
            final short v = object.shortValue();
