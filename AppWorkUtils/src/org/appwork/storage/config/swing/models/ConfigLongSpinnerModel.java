...
public class ConfigLongSpinnerModel extends SpinnerNumberModel implements ValueProviderListener<Long> {
    /**
     *
     */
    ...
    public void setValue(Object value) {
        try {
            if (value instanceof Number) {
                provider.set(((Number) value).longValue());
            } else if (value instanceof String && ((String) value).matches("^-?\\d+$")) {
                provider.set(Long.valueOf(String.valueOf(value)));
            }
