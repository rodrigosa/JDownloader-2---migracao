...
public class ConfigShortSpinnerModel extends SpinnerNumberModel implements ValueProviderListener<Short> {
    /**
     *
     */
    ...
    public void setMinimum(Comparable minimum) {
        super.setMinimum(((Number) minimum).shortValue());
    }

    @Override
    public void setMaximum(Comparable maximum) {
        super.setMaximum(((Number) maximum).shortValue());
    }
    ...
    protected Number incrValue(final short i) {
    ...
    public void setValue(Object value) {
        try {
            if (value instanceof Number) {
                provider.set(((Number) value).shortValue());
            } else if (value instanceof String && ((String) value).matches("^-?\\d+$")) {
                provider.set(Short.valueOf(String.valueOf(value)));
            }
