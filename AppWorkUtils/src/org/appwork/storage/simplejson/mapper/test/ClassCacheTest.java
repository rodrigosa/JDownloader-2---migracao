 ...
 *
 */
public class ClassCacheTest extends AWTest {
    public static interface TestConfigInterface extends FlexiStorableInterface {
        ...
        ArrayList<String> getGeneric();

        void setGeneric(ArrayList<String> value);
    ...
    public void runTest() throws Exception {
        ...
        ClassCache cc = ClassCache.getClassCache(storage.getClass());
        assertThat(cc.getProperty("generic").type).is(CompiledType.create(TypeRef.STRING_LIST));
        CompiledType ct = CompiledType.create(storage.getClass());
        assertTrue(ct.isInstanceOf(Proxy.class));
    }
