 ...
 *
 */
public class CompareTest extends AWTest {
    /**
     * @return
     */
    ...
    public void runTest() throws Exception {
        ...
        assertTrue(JSonStorage.serializeToJson(obj).equals(JSonStorage.serializeToJson(re)));
        assertTrue(CompareUtils.equalsDeep(obj, re));
    }
}
