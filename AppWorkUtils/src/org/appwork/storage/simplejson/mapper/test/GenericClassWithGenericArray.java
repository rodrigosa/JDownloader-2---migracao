...
public class GenericClassWithGenericArray<TargetType, MatcherType> implements Storable {
    private Condition<MatcherType>[]              conditions;
    private GenericListTypeTestClass<MatcherType> genericList;

    public GenericListTypeTestClass<MatcherType> getGenericList() {
        return genericList;
    }

    public void setGenericList(GenericListTypeTestClass<MatcherType> genericList) {
