 ...
 *
 */
public class Getter implements GetterOrSetter {
     ...
     * @param substring
     */
    public Getter(ClassCache cc, final String name, List<String> alternativeKeys, final Method m, Field field) {
        this.classCache = cc;
        this.key = name;
        this.field = field;
        this.method = m;
    ...
    public Getter(ClassCache cc, final String name, final Method m) {
