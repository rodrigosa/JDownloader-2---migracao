 ...
 * @author thomas
 */
public class JSonFactory extends JSonParser {
    ...
    public JSonFactory(final String json, boolean naNAllowed) {
        super(json, naNAllowed);
    }

    public JSonNode parse() throws ParserException {
        return (JSonNode) super.parse();
    }
    ...
    @Override
    protected JSonValue createJSonValue(Number number) {
    ...
    @Override
    protected JSonValue createJSonValue(boolean b) {
        if (b) {
