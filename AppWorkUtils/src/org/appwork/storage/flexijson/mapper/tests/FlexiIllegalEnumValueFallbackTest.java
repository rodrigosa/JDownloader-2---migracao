 ...
 *
 */
public class FlexiIllegalEnumValueFallbackTest extends AWTest {
    ...
    public void runTest() throws Exception {
        assertTrue(FlexiUtils.jsonToObject("\"TEST2\"", CompiledType.create(MyEnum.class)) == MyEnum.TEST3);
        assertTrue(FlexiUtils.jsonToObject("\"TEST3\"", CompiledType.create(MyEnum.class)) == MyEnum.TEST3);
    }
}
