 ...
 *
 */
public class ReadableBytesMapper implements FlexiTypeMapper {
    /**
     *
     */
    ...
    public Object json2Obj(FlexiJSonMapper mapper, FlexiJSonNode node, CompiledType type, Setter setter) throws FlexiMapperException {
        if (node instanceof FlexiJSonValue) {
            ...
            case STRING:
                ...
                try {
                    return ReadableBytes.parse((String) ((FlexiJSonValue) node).getValue());
        ...
        throw new WTFException("Cannot Map node");
    }

    @Override
    public boolean canConvert2Json(Object obj, Getter getter) {
        return obj != null && obj instanceof ReadableBytes;
    }

    @Override
    public boolean canConvert2Object(FlexiJSonNode node, CompiledType type, Setter setter) {
        return type.isInstanceOf(ReadableBytes.class) && node instanceof FlexiJSonValue;
    }
}
