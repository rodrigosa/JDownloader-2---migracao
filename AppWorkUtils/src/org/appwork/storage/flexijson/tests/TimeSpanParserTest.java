...
public class TimeSpanParserTest extends AWTest {
    ...
    public void runTest() throws Exception {
        assertThat(FlexiUtils.jsonToObject("60", FlexiJSONParser.IGNORE_LIST_ENSURE_CORRECT_VALUES, new SimpleTypeRef<TimeSpan>(TimeSpan.class)).toLong(Unit.MILLISECONDS)).isNumber(60);
    }
}
