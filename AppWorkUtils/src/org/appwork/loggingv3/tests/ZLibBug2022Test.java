 ...
 *
 */
public class ZLibBug2022Test extends AWTest {
    /**
     *
     */
    ...
    protected void testDeflater() throws IOException, Error, Exception {
        ...
        DeflaterOutputStream zipout = new DeflaterOutputStream(baos = new ByteArrayOutputStream(), new Deflater(7, true));
        try {
        ...
        assertEquals(Hash.getSHA256(IO.readStream(-1, ZLibBug2022Test.class.getResource(REPRO_7_15_1_DEFAULTSTRATEGY_TXT_TXT).openStream())), Hash.getSHA256(bytes));
    }

    protected void testZipOutputStream() throws IOException, Error, Exception {
        ByteArrayOutputStream baos;
        ZipOutputStream zipout = new ZipOutputStream(baos = new ByteArrayOutputStream());
        try {
            zipout.setLevel(7);
