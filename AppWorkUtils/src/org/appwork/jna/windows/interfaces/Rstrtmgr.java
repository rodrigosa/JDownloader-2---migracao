...
public interface Rstrtmgr extends Library {
    ...
    int RmRegisterResources(int sessionHandle, int nFiles, WString[] rgsFilenames, int nApplications, Pointer applications, int nServices, Pointer services);

    int RmGetList(int sessionHandle, IntByReference pnProcInfoNeeded, IntByReference pnProcInfo, RM_PROCESS_INFO[] rgAffectedApps, IntByReference lpdwRebootReasons);
