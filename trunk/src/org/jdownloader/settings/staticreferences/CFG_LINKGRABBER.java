...
public class CFG_LINKGRABBER {
    ...
    public static final BooleanKeyHandler                   ADD_LINKS_PRE_PARSER_AUTO_EXTRACTION_PASSWORD_SEARCH_ENABLED = SH.getKeyHandler("AddLinksPreParserAutoExtractionPasswordSearchEnabled", BooleanKeyHandler.class);
    /**
