...
public class MixSharedCom extends XFileSharingProBasic {
    public MixSharedCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2020-05-28: No limits at all <br />
     * captchatype-info: 2020-05-28: 4dignum<br />
     * other:<br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "mixshared.com" });
        return ret;
    }
    ...
    public String getLoginURL() {
        /* 2020-05-28: Special */
        return getMainPage() + "/sign-in.html";
    }
}