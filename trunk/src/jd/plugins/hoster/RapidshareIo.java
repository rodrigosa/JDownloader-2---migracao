...
@HostPlugin(revision = "$Revision: 47729 $", interfaceVersion = 2, names = {}, urls = {})
public class RapidshareIo extends YetiShareCore {
    public RapidshareIo(PluginWrapper wrapper) {
        super(wrapper);
