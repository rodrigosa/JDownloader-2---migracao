...
import org.jdownloader.plugins.components.config.EvilangelCoreConfigDfxtra;
...
public class EvilangelDfxtraCom extends EvilangelCore {
    ...
    public Class<? extends EvilangelCoreConfig> getConfigInterface() {
        return EvilangelCoreConfigDfxtra.class;
    }

    @Override
    protected String getNamespaceLogin() {
        return "https://members." + this.getHost() + "/en/login";
    }
