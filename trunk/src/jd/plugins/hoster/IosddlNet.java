...
public class IosddlNet extends YetiShareCore {
    public IosddlNet(PluginWrapper wrapper) {
        super(wrapper);
     ...
     * limit-info: 2019-02-20: Premium untested, set FREE account limits<br />
     * captchatype-info: 2019-02-20: null<br />
     * other: <br />
     */
    /* 1st domain = current domain! */
    public static String[] domains = new String[] { "iosddl.net" };
