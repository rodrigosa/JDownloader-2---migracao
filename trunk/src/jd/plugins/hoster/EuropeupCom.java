...
@HostPlugin(revision = "$Revision: 46569 $", interfaceVersion = 3, names = {}, urls = {})
public class EuropeupCom extends XFileSharingProBasic {
    public EuropeupCom(final PluginWrapper wrapper) {
        super(wrapper);
     ...
     * other: 2019-05-29: special: captcha is not required for all files!<br />
     */
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "europeup.com" });
        return ret;
    }
