...
@HostPlugin(revision = "$Revision: 46498 $", interfaceVersion = 2, names = {}, urls = {})
public class OneFilesharingCom extends YetiShareCore {
     ...
     * limit-info:<br />
     * captchatype-info: 2020-02-27: reCaptchaV2<br />
     * other: <br />
     */
    public static List<String[]> getPluginDomains() {
        final List<String[]> ret = new ArrayList<String[]>();
        // each entry in List<String[]> will result in one PluginForHost, Plugin.getHost() will return String[0]->main domain
        ret.add(new String[] { "1filesharing.com" });
        return ret;
    }
