...
@DecrypterPlugin(revision = "$Revision: 48306 $", interfaceVersion = 3, names = { "turboimagehost.com", "turboimagehost.com" }, urls = { "https?://(?:www\\.)?turboimagehost\\.com/p/\\d+/[^/]+\\.html|https?://[a-z0-9\\-]+\\.turboimg\\.net/t1/\\d+_[^/]+", "https?://(?:www\\.)?turboimagehost\\.com/album/\\d+/[^/]+" })
