...
public class SoundCloudComDecrypterShorturls extends PluginForDecrypt {
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
        ...
        final PluginForDecrypt soundcloudCrawlerplugin = this.getNewPluginForDecryptInstance("soundcloud.com");
        if (!soundcloudCrawlerplugin.canHandle(redirect)) {
            throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
        }
